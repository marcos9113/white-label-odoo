...
class ResConfigSettings(models.TransientModel):
    ...
    gamerun_app_name = fields.Char("App name", config_parameter='gamerun_whitelabel.new_name')
    gamerun_app_title = fields.Char("App title", config_parameter='gamerun_whitelabel.new_title')
    gamerun_app_website = fields.Char("App website", config_parameter='gamerun_whitelabel.new_website')
    gamerun_app_favicon_url = fields.Char("App favicon URL", config_parameter='gamerun_whitelabel.favicon_url')
