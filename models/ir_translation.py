...
def debrand(env, source, is_code=False):
    ...
    new_name = params.get("gamerun_whitelabel.new_name")
    new_website = params.get("gamerun_whitelabel.new_website")
    new_documentation_website = params.get("gamerun_whitelabel.new_documentation_website")
